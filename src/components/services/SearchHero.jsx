            ...
            <div className="relative">
              <div className="relative flex items-center">
                ...
                {showSuggestions && suggestions.length > 0 && (
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-primary/20 rounded-lg shadow-lg z-10 max-h-48 overflow-y-auto pointer-events-none">
                    {suggestions.map(name => (
                      <button
                        ...
                        className="w-full text-left px-4 py-2.5 text-sm hover:bg-primary/10 border-b border-primary/10 last:border-b-0 transition-colors pointer-events-auto"
                      >
                        {name}
                      </button>
                    ))}
